...
////////////////////////////////////////////////////////////////////////////////////////////////////
(Method Signature): 
جاڤا تەنها سەیری ناوی مێتۆدەکە و لیستی پارامەترەکانی دەکات. کاتێک ناوی مێتۆدەکان وەک یەک بوو، تەنها بە گۆڕینی یەکێک لەو سێ شتەی کە باست کردووە (ژمارە، ڕیزبەندی، یان جۆری داتا) مێتۆدەکە ئۆڤەرلۆد دەبێت.
​
(خاو نەبوونەوەی پرۆگرام): 
چونکە جاڤا پێش ئەوەی پرۆگرامەکە ڕەن ببێت 
کاتی( Compile-time)، پێشوەختە بڕیار دەدات کام مێتۆد جێبەجێ ببێت، بۆیە لە کاتی کارکردنی بەرنامەکەدا هیچ کاتێک بەفیڕۆ ناچێت و خاوبوونەوە دروست ناکات

void print(int a) { System.out.println("ئاسایی"); }
ئەوە تەنها یەک ژمارە وەربگرێت 
void print(int... a) { System.out.println("گۆڕاو"); }
 دەکرێت (هیچ یان یەک یان دوو ...هتد) ژمارە وەربگرێت 

  لە چاوپێکەوتنی کاردا حەز دەکەن وشە ئەکادیمییەکان ببیستن.
   Method Overloading دەوترێت Compile-time Polymorphism (یاخود Static Binding). کاتێک دەپرسن بۆچی؟ بڵێ: چونکە کۆمپایلەر لە کاتی دروستکردنی کۆدەکەدا بڕیار دەدات کام مێتۆد بەکاربهێنرێت، نەک لە کاتی کارپێکردنیدا
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  public class GuessNumber {
    public static void main(String[] args) {

        System.out.println(calculate(12.0, 23.0));   // labar away 1 method 2 parametery haay keshay nya 
        System.out.println(calculate(12.0, 23, 23.0));   // lera labar away 2 method 3 parametery haya boya dabet dyari bkay inta yan double
